package io.github.acopier.raildest.schedulers.folia;

import io.github.acopier.raildest.schedulers.base.ScheduledTask;
...
public class FoliaTaskScheduler implements TaskScheduler {
  ...
  protected final GlobalRegionScheduler globalRegionScheduler = Bukkit.getServer().getGlobalRegionScheduler();
